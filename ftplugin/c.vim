" Based on Bart's c.vim from
" http://www.jukie.net/~bart/blog/find-functions-in-vim
" Modified by Nathan Stien <nathanism@gmail.com>
...
" make ]] and [[ work with non K&R style
" from http://www.jukie.net/~bart/blog/find-functions-in-vim
